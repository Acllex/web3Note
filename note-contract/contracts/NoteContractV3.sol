...
contract NoteContractV3 is Initializable, ERC721URIStorageUpgradeable {
    ...
    function burnTokenId(uint tokenId) public {
        ...
        require(msg.sender == owner, "You are not the creator of this note");
        _burn(tokenId);
    }
    ...
    // 获取笔记数量
    function getOwnedNotesNum() view public returns (uint){
